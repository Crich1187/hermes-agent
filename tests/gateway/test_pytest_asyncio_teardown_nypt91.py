...
@pytest.mark.parametrize(
    "nodeid",
    [
        # Household fork tip lacks the upstream media/delivery files from the
        # unrelated-history candidate; prove terminal exit on the replayed
        # regressions themselves (same faulthandler contract).
        "tests/gateway/test_pytest_asyncio_teardown_nypt91.py::"
        "test_process_message_leaves_no_typing_task",
        "tests/gateway/test_pytest_asyncio_teardown_nypt91.py::"
        "test_stop_typing_refresh_sets_stop_event_and_joins",
        "tests/gateway/test_pytest_asyncio_teardown_nypt91.py::"
        "test_stop_typing_refresh_propagates_outer_cancel_after_joining_child",
    ],
)
